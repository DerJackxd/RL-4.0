...
class Life_Settings {
	...
	gang_price = 2000000; //Price for creating a gang, remember they are persistent so keep it reasonable to avoid millions of gangs.
...
class VirtualItems {
  ...
  VITEMMACRO(bottledbeer, "STR_Item_BottledBeer", "bottledbeer", 4, 8500, 10000, false, -1, "icons\fbier.paa", -1) //noch kein Bild
  VITEMMACRO(bottles, "STR_Item_Bottles", "bottles", 1, 2800, 75, false, -1, "icons\flasche.paa", -1)
  ...
  VITEMMACRO(farbstoff, "STR_Item_Farbstoff", "farbstoff", 2, -1, 3000, false, -1, "icons\farbstoff.paa", -1)
	...
	VITEMMACRO(coffee, "STR_Item_Coffee", "coffee", 1, 55, 5, false, 100, "icons\ico_coffee.paa", -1)
...
*/
class Licenses {
	LICENSEMACRO(driver,"STR_License_Driver","driver",1500,false,"civ", -1)
	LICENSEMACRO(boat,"STR_License_Boat","boat",8000,false,"civ", -1)
	LICENSEMACRO(pilot,"STR_License_Pilot","pilot",45000,false,"civ", -1)
	LICENSEMACRO(gun,"STR_License_Firearm","gun",50000,false,"civ", 3)
	LICENSEMACRO(dive,"STR_License_Diving","dive",4000,false,"civ", -1)
	LICENSEMACRO(oil,"STR_License_Oil","oil",20000,false,"civ", 3)
	...
	LICENSEMACRO(sand,"STR_License_Sand","sand",9500,false,"civ", 3)
	LICENSEMACRO(iron,"STR_License_Iron","iron",14000,false,"civ", 2)
	LICENSEMACRO(copper,"STR_License_Copper","copper",12000,false,"civ", 2)
	LICENSEMACRO(cement,"STR_License_Cement","cement",7500,false,"civ", 3)
	LICENSEMACRO(mAir,"STR_License_Pilot","mAir",15000,false,"med", -1)
	LICENSEMACRO(home,"STR_License_Home","home",800000,false,"civ", -1)
	LICENSEMACRO(aAir,"STR_License_ADAC","aAir",15000,false,"adac", -1)
	LICENSEMACRO(meth,"STR_License_Meth","meth",128000,false,"civ", 8)
	LICENSEMACRO(gold,"STR_License_Gold","gold",36000,false,"civ", 4)
	LICENSEMACRO(silber,"STR_License_Silber","silber",17500,false,"civ", 4)
	LICENSEMACRO(uran,"STR_License_Uran","uran",140000,true,"civ", 8)
	LICENSEMACRO(lsd,"STR_License_Lsd","lsd",125000,true,"civ", 7)
	LICENSEMACRO(pcola,"STR_License_Pcola","pcola",3000,false,"civ", -1)
	LICENSEMACRO(sotb,"STR_License_Sotb","sotb",2500,false,"civ", -1)
	LICENSEMACRO(mait,"STR_License_Mait","mait",2500,false,"civ", -1)
	LICENSEMACRO(stiller,"STR_License_Stiller","stiller",55000,true,"civ", 5)
	LICENSEMACRO(liquor,"STR_License_Liquor","liquor",110000,false,"civ", 4)
	LICENSEMACRO(bottler,"STR_License_Bottler","bottler",110000,false,"civ", 3)
	LICENSEMACRO(hunting,"STR_License_Hunting","hunting",140000,false,"civ", 3)
	LICENSEMACRO(antiquitaeten,"STR_License_Antiquitaeten","antiquitaeten",550000,false,"civ", 9)
	LICENSEMACRO(mash,"STR_License_Mash","mash",110000,false,"civ", 5)
	LICENSEMACRO(craftVehicle,"STR_License_craftVehicle","craftVehicle",450000,false,"civ", -1)
	LICENSEMACRO(craftWeapon,"STR_License_craftWeapon","craftWeapon",450000,false,"civ", -1)
	LICENSEMACRO(craftClothing,"STR_License_craftClothing","craftClothing",250000,false,"civ", -1)
	LICENSEMACRO(taxi,"STR_License_Taxi","taxi",62000,false,"civ", -1)
	LICENSEMACRO(gang,"STR_License_Gang","gang",120000,false,"civ", -1)
    LICENSEMACRO(kohle,"STR_License_Kohle","kohle",9500,false,"civ", 2)
...
class VirtualShops {
    ...
    class cop_gear {
        ...
        items[] = {"gpstracker","adac_toolkit","fuelFull","battery", "carCharger", "repairkit","firstaidkit","bd_mk1_bleachweapon","bd_mk1_ammo","troll_taschentuch","troll_nuckel","troll_bitering","troll_money","defusekit","speedtrap","laptop"};
    };

    class adac {
		name = "STR_Shops_ADAC"	;
		items[] = {"waterBottle", "rabbit_grilled", "apple", "redgull", "tbacon", "carCharger", "wkasten", "fuelEmpty","fuelFull","fuelPipe","adac_toolkit","battery","repairkit","firstaidkit"};
	};

    class medic {
        name = "STR_Shops_Medic";
        items[] = {"waterBottle", "rabbit_grilled", "apple", "redgull", "tbacon", "carCharger", "fuelFull","battery","repairkit","firstaidkit","organttk","kidney"};
    };
	...
	class gas {
		name = "STR_Shops_Gas";
		items[] = {"waterBottle","tbacon","rabbit_grilled","banane","birne","cerises", "apple","oil_unprocessed","fuelFull","pickaxe", "carCharger"};
	};
