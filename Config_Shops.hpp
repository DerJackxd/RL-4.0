class WeaponShops {
    ...
    class cop_basic {
        ...
        { "SMG_01_ACO_F", "TEST 1", 20000, { "life_coplevel", 4 } },
        { "arifle_SDAR_F", "TEST 2", 20000, { "life_coplevel",  5 } },
  			{""},
  			{ "16Rnd_9x21_Mag", "", 50, "" },
    ...
    class cop_patrol {
      ...
      { "arifle_MXC_Black_F", "", 30000, "" },
			...
			{ "20Rnd_762x51_Mag", "Mk 18 Mag", 750, "" },
			...
			{ "R3F_SILENCIEUX_HK417", "HK417M Schalldämpfer",800, "" },
