...
switch (typeOf _vehicle) do {
	...
	case "Orel_Master": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "B_Truck_01_transport_F": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "B_Truck_01_mover_F": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "A3L_Towtruck": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "B_Heli_Light_01_F": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "I_Heli_Transport_02_F": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "EC635_ADAC": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "I_Heli_light_03_unarmed_F": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "C_SUV_01_F": { _attach = [[-0.4, 2.3, -0.55], [0.4, 2.3, -0.52]]; };
	case "B_MRAP_01_F": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "DAR_M1152": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
};
