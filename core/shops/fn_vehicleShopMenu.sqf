...
if(isNil "_shopType") then {_shopType = "Car";};

if(EQUAL(_shopType,"Car")) then {_vehicleBoxPos = [628.1,1258.8,0]};
if(EQUAL(_shopType,"Air")) then {_vehicleBoxPos = [6895.98,18165,0]};
if(EQUAL(_shopType,"Ship")) then {_vehicleBoxPos = [443.417,1456.49,0]};
...
if(EQUAL(_shopType,"Car")) then {_camPos = [SEL(_vehicleBoxPos,0) - 5,SEL(_vehicleBoxPos,1) + 10,SEL(_vehicleBoxPos,2) + 8]};
