...
execvm "core\licenses\tests\troll_prevent.sqf";
...
TitleText["Fliege nun nach Panochori (DP8) , dort ist wieder einer der Pfeile. Lande dort, das ganze aber innerhalb von 2 min.","BLACK FADED", 2];
sleep 8;
titleFadeOut 2;
