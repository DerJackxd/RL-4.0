...
_hideout = (nearestObjects[getPosATL player,["Land_u_Barracks_V2_F","Land_i_Barracks_V2_F","Land_i_Stone_HouseSmall_V2_F"],25]) select 0;
...
titleText["Gangversteck wurde erobert!.","PLAIN"];
_flagTexture = [
