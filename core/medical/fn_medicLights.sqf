...
switch (typeOf _vehicle) do {
	...
	case "a3l_laddertruck": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "B_MRAP_01_F": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "EWK_HMMWV_Medevac": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "ACR_LandRover_AMB": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
