...
if(life_firstSpawn) then 
{
	switch (playerSide) do
	{
		...
		{
			_text = [
				format ["<t align='left'>Wenn das dein erster Besuch auf unserem Server ist, bitten wir dich, die Regeln genauestens durchzulesen. Dies kannst du auf der Homepage: <t color='#428BCA'>http://realliferpg.de/</t> tun oder alternativ auf der Karte indem du <t color='#FF8000'>M</t> drueckst.</t>"],
				...
				format ["<t align='left'><t color='#ff1111'>RealLifeRPG befindet sich noch in der Entwicklungsphase. Welche Verluste erstattet werden könnt ihr auf unserer Homepage nachlesen!!!</t>"],
				format ["<t align='left'>Die Admins wünschen dir viel Spaß auf diesem Server.</t>"],
				format ["<t align='left' color='#428BCA'>TS3 : ts.realliferpg.de</t>"],
				format ["<t align='left' color='#428BCA'>Homepage : http://realliferpg.de</t>"]
			];
		};
		...
		{
			_text = [
				format ["<t align='left'>Wenn das dein erster Besuch auf unserem Server ist, bitten wir dich, die Regeln genauestens durchzulesen. Dies kannst du auf der Homepage: <t color='#428BCA'>http://realliferpg/</t> tun oder alternativ auf der Karte indem du <t color='#FF8000'>M</t> drueckst.</t>"],
		...
		case civilian:
		{
			_text = [
				...
				format ["<t align='left'>Wir legen auf unserem Server viel Wert auf RP also verhalte dich dementsprechend. Zuwiederhandlung z.b. (Trolling, RDM, VDM usw.) wird mit einem BAN bestrafft!!!.</t"],
				format ["<t align='left'>Desyncs: Die meisten desyncs sind durch die Clients bedingt, bei einer Framerate unter 30 FPS ist der Armaclient überlastet und hat Probleme die Netzwerkkommunikation zu verwalten.</t>"],
				format ["<t align='left'><t color='#ff1111'>RealLifeRPG befindet sich noch in der Entwicklungsphase. Welche Verluste erstattet werden könnt ihr auf unserer Homepage nachlesen!!!</t>"],
				format ["<t align='left'>Die Admins wünschen dir viel Spaß auf diesem Server.</t>"],
				format ["<t align='left' color='#428BCA'>TS3 : ts.realliferpg.de</t>"],
