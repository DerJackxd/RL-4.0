...
switch (typeOf _vehicle) do {
	...
	case "cl3_escalade_patrolwb": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "cl3_q7_clpd_patrol": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "C_SUV_01_F": { _attach = [[-0.4, 2.3, -0.55], [0.4, 2.3, -0.52]]; };
	case "DAR_DAR_02FirebirdSSVPolice": { _attach = [[-0.4, 2.3, -0.55], [0.4, 2.3, -0.52]]; };
	case "cl3_reventon_clpd": { _attach = [[-0.4, 2.3, -0.55], [0.4, 2.3, -0.52]]; };
	case "B_Heli_Light_01_F": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "I_MRAP_03_F": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };	
	case "CL3_bus_cl_jail": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };	
	case "B_MRAP_01_F": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "cl3_transitpatrol": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "EWK_HMMWV_Light": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "HMMWV_M1035": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };
	case "I_Heli_light_03_unarmed_F": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "dezkit_b206_police": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "O_Heli_Transport_04_F": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "dezkit_b206_fbi": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "B_Heli_Transport_03_unarmed_F": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "EC635_Unarmed": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
	case "O_Heli_Transport_04_box_F": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
};
