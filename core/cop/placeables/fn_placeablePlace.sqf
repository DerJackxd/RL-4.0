...
if (life_barrier_active) exitWith {closeDialog 0; hint "Sie koennen nur ein Objekt auf einmal plazieren!";};
if (count life_bar_placey >= life_bar_limit) exitWith { hint "Sie haben das Limit von Objekten die Sie plazieren koennen erreicht."; };
