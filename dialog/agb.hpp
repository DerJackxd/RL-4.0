class agb
{
	...
	class controlsBackground
	{
		...
		class RscTitleText : Life_RscTitle
		{
			...
			idc = -1;
			text = "Willkommen auf dem GBB Alits Life Server!";
			x = 0.0875;
			y = 0.06;
			w = 0.825;
			h = 0.04;
