class Life_ColorList
{
	...
	class controls
	{
		...
		{
			idc = -1;
			text = "Waehle bitte die Fahrzeugfarbe aus die dein Fahrzeug nach der Herstellung haben soll!! ACHTUNG: Du musst an einem Crafting Laden sein (für Heli oder Car jenachdem) und ein ToolKit besitzen"; //--- ToDo: Localize;
			x = 0.212499;
			y = 0.300001;
			w = 0.5875;
			h = 0.15;
