...
switch (_ziel) do
{
	...
	case "Sydney": {_cash = 12200; _time1 = (2*60); _time2 = (3 * 60);};
	case "Brisbane": {_cash = 12800; _time1 = (2*60); _time2 = (3 * 60);};
	case "Melbourne": {_cash = 23800; _time1 = (2*60); _time2 = (3 * 60);};
	case "Abschlepphof": {_cash = 23500; _time1 = (2*60); _time2 = (5 * 60);};
