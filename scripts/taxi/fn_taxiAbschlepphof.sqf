...
switch (_ziel) do
{
	case "Alice Springs": {_cash = 12200; _time1 = (2*60); _time2 = (3 * 60);};
	case "Sydney": {_cash = 13400; _time1 = (2*60); _time2 = (3 * 60);};
	case "Melbourne": {_cash = 9100; _time1 = (2*60); _time2 = (2 * 60);};
	case "Perth": {_cash = 23500; _time1 = (2*60); _time2 = (5 * 60);};
	case "Brisbane": {_cash = 17400; _time1 = (2*60); _time2 = (4 * 60);};
