...
switch (_ziel) do
{
	case "Melbourne": {_cash = 12000; _time1 = (2*60); _time2 = (3 * 60);};
	case "Sydney": {_cash = 2100; _time1 = (2*60); _time2 = (1 * 60);};
	case "Brisbane": {_cash = 6900; _time1 = (2*60); _time2 = (2 * 60);};
	case "Perth": {_cash = 12000; _time1 = (2*60); _time2 = (3 * 60);};
	case "Abschlepphof": {_cash = 12200; _time1 = (2*60); _time2 = (3 * 60);};
