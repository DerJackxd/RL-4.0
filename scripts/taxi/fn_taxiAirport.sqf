...
switch (_ziel) do
{
	case "Alice Springs": {_cash = 2100; _time1 = (2*60); _time2 = (1 * 60);};
	case "Melbourne": {_cash = 11600; _time1 = (2*60); _time2 = (3 * 60);};
	case "Brisbane": {_cash = 4800; _time1 = (2*60); _time2 = (1 * 60);};
	case "Perth": {_cash = 12200; _time1 = (2*60); _time2 = (3 * 60);};
	case "Abschlepphof": {_cash = 13400; _time1 = (2*60); _time2 = (3 * 60);};
    case "Tasmania": {_cash = 23500; _time1 = (2*60); _time2 = (5 * 60);};
};
