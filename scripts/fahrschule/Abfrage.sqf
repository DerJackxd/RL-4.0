...
if(life_cash < 1500) exitWith { hint "Du benoetigst 1500$ um an der Pruefung teilzunehmen";};
if (license_civ_driver) exitWith {hint "Du besitzt bereits den Fuehrerschein";};
if (life_car_license_test) exitWith {hint "Gerade absolviert jemand den Fuehrerschein Bitte Gedulde dich ein paar Minuten!";};
life_car_license_test = true;
