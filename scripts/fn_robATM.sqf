...
if(_rip) then
{
    ...
    while{true} do
    {
        ...
        if((_robber GVAR["restrained",false])) exitWith { [[1,player],"life_fnc_createMarker",west,false] spawn life_fnc_MP;};
    
    };  
    if!(alive _robber) exitWith { _rip = false; [[getPlayerUID _robber,name _robber,"48"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP; [[1,player],"life_fnc_createMarker",west,false] spawn life_fnc_MP;};
    if(life_istazed) exitWith { _rip = false; [[getPlayerUID _robber,name _robber,"48"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP; [[1,player],"life_fnc_createMarker",west,false] spawn life_fnc_MP;};   
