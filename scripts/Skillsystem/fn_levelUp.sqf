...
switch(_level) do {
	...
	case 2:
	{
		...
		_role4 = "Neue Funktionen";
		_role4names = ["Kupfer farmen", "Eisen farmen", "Holz farmen"];
		_role5 = "Zusatz:";
		_role5names = ["Neuer Skillpunkt"];
	...
	case 5:
	{
		...
		_role3 = "Neue Fahrzeuge:";
		_role3names = ["Zamak Transport", "Zamak abgedeckt", "Tempest Tanker klein", "MH-9 Hummingbird", "M-900"];
		_role4 = "Neue Funktionen";
		_role4names = ["Diamanten farmen", "Müll", "Salz farmen", "Wisky herstellen"];
		_role5 = "Zusatz";
	...
	case 7:
	{
		...
		_role4 = "Neue Funktionen";
		_role4names = ["LSD farmen", "Heroin farmen"];
		_role5 = "Zusatz";
		_role5names = ["2 neue Skillpunkte"];
	...
	case 8:
	{
		...
		_role4 = "Neue Funktionen";
		_role4names = ["Uran farmen", "Meth farmen"];
		_role5 = "Zusatz";
		_role5names = ["2 neue Skillpunkte", "Neue Crafting möglichkeiten"];
	...
	case 9:
	{
		...
		_role3 = "Neue Fahrzeuge:";
		_role3names = ["Tempest Gerät", "Orca"];
		_role4 = "Neue Funktionen";
