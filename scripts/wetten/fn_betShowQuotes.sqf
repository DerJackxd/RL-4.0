...
switch (_x) do
	{
		case 0: 	{ life_club1 = "FC Melbourne";}; 	
		case 1: 	{ life_club1 = "2033 Perth";}; 		
		case 2: 	{ life_club1 = "Eintracht Sydney";};	
		case 3: 	{ life_club1 = "VFB Brisbane";};
		case 4: 	{ life_club1 = "BVB Zaros";};	
		case 5: 	{ life_club1 = "Alice Springs SV";};		
		case 6: 	{ life_club1 = "1.FC Tasmania";};	
...
switch (_y) do
	{
		case 0: 	{ life_club2 = "FC Melbourne";}; 	
		case 1: 	{ life_club2 = "2033 Perth";}; 		
		case 2: 	{ life_club2 = "Eintracht Sydney";};	
		case 3: 	{ life_club2 = "VFB Brisbane";};
		case 4: 	{ life_club2 = "BVB Zaros";};	
		case 5: 	{ life_club2 = "Alice Springs SV";};				
		case 6: 	{ life_club2 = "1.FC Tasmania";};	
